//
// Created by Timofey Tavlintsev on 14/10/2018.
//
...
class ofxLedGrabLine {
    ...
    ofxLedGrabLine(ofxLedGrabLine &&other) noexcept = default;
    ofxLedGrabLine &operator=(ofxLedGrabLine &&other) noexcept = default;
};